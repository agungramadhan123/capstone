# ============================================================
# [RESTRUCTURED] File dipindahkan dari root/ → src/
# Lokasi baru: src/preprocessing.py
# Perubahan: PROJECT_ROOT diupdate agar tetap menunjuk ke root project
# Cara menjalankan: python src/preprocessing.py --lokasi bubat_barat
# ============================================================
"""
